...
class Conversation:
    def __init__(self, conversation_id: str, host_name: str, host_logo: str, host_url: str, data_dir: str="./Output/chat"):
    ...
    def save_conversation(self):
        data = {"conversation_id": self.conv_id, "timestamp": self.timestamp, 
                "host_name": self.host_name, "host_logo": self.host_logo, "host_url": self.host_url,  
